...
If you are on Windows, it is recommended that you install Windows Subsystem for Linux (WSL). See the [Getting Started](https://webcms3.cse.unsw.edu.au/COMP1531/23T1/resources/83824) section from webcms3 for further guidance.
